...
bool SqlDao::regUser(const std::string& name, const std::string& email, const std::string& pwd)
{
    ...
    try {
        ...
        bind[2].buffer = const_cast<char*>(pwd.data());
        bind[2].buffer_length = pwd.size();
